...
export const UnoCardView: React.FC<UnoCardViewProps> = React.memo(({
  ...
  return (
    <div
      onClick={onClick}
      className={`relative ${sizeStyles.width} ${sizeStyles.height} ${sizeStyles.rounded} ${sizeStyles.padding} ${theme.bg} border ${theme.border} select-none transition-all duration-150 ${onClick ? 'cursor-pointer active:scale-95' : ''} ${
